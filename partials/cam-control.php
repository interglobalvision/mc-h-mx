      ...
      <div class="grid-item item-s-5 grid-row justify-end">
        <div class="cam-buttons grid-column justify-between">
          <div class="grid-item item-s-6 no-gutter grid-row justify-between">
            <button id="cam-button-up" class="cam-ui cam-button" data-action="up"></button>
            <button id="cam-button-right" class="cam-ui cam-button" data-action="right"></button>
          </div>
          <div class="grid-item item-s-6 no-gutter grid-row justify-between align-items-end">
            <button id="cam-button-left" class="cam-ui cam-button" data-action="left"></button>
            <button id="cam-button-down" class="cam-ui cam-button" data-action="down"></button>
          </div>
        </button>
      </div>
  </div>
